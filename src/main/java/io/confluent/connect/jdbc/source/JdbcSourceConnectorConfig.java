...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static ConfigDef baseConfigDef() {
    return new ConfigDef()
        ...
        .define(INCREMENTING_COLUMN_USE_PRIMARY_KEY_CONFIG, Type.BOOLEAN, INCREMENTING_COLUMN_USE_PRIMARY_KEY_DEFAULT, Importance.MEDIUM, INCREMENTING_COLUMN_USE_PRIMARY_KEY_DOC, MODE_GROUP, 3, Width.MEDIUM, INCREMENTING_COLUMN_USE_PRIMARY_KEY_DISPLAY,
                MODE_DEPENDENTS_RECOMMENDER)
